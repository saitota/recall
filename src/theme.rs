...
pub struct Theme {
    ...
    /// Cursor message bubble background
    pub cursor_bubble_bg: Color,
    /// Cursor source indicator color
    pub cursor_source: Color,
...
impl Theme {
    ...
    fn dark() -> Self {
        Self {
            ...
            cursor_bubble_bg: Color::Rgb(35, 35, 50),  // subtle indigo tint
            cursor_source: Color::Rgb(130, 130, 220),   // Cursor indigo
    ...
    fn light() -> Self {
        Self {
            ...
            cursor_bubble_bg: Color::Rgb(230, 230, 245), // subtle indigo tint
            cursor_source: Color::Rgb(80, 80, 170),   // Cursor indigo (darker for light bg)
